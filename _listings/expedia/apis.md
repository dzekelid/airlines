...
- name: Expedia Get the credit card fee for a trip
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/airlines/master/_listings/expedia/api-flight-trip-cardfee-post.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/airlines/master/_listings/expedia/api-flight-trip-cardfee-post-postman.md
x-common:
- type: x-base
